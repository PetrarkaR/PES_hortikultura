...
\subsection{Šema Slejv automata}
  Električna šema Slejv automata sastoji se od razvojne ploče sa mikrokontrolerom PIC16F877A, RS-232/RS485 komunikacionog interfejsa, 16x2 LCD displeja, tastera za manuelno zalivanje, tastera za resetovanje lokalnog stanja, analognog ulaza za senzor protoka i indikacionih izlaza za stanje sistema, rad pumpe i alarm.
  ...
  Za Slejv automat izabran je PIC16F877A, jer obezbeđuje dovoljan broj digitalnih ulaza i izlaza, UART komunikaciju, Tajmer 1, A/D konvertor i paralelno povezivanje LCD displeja.
  Mikrokontroler radi na taktu od 20 MHz i napajanju od 5 V.
  Kao i kod Master automata, serijska komunikacija koristi UART modul, dok se izbor između RS-232 i RS485 veze vrši kratkospojnicima na razvojnoj ploči.
...
void init_variables()
{
  ...
  Port B je podešen kao ulaz za tastere, port C sadrži UART linije, LCD kontrolne linije i \texttt{DR} signal RS485 drajvera, dok se port D koristi i za ID uređaja i za podatke LCD displeja.
