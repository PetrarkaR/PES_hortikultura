...
#define PinPump PORTA.F3 // Pumpa (1=ukljucena)

#define PinAlarm PORTA.F4 // Zvucni alarm

#define PinStatusLED PORTA.F2 // LED - sistem ukljucen

#define DR PORTC.F5 // RS485 smer (1=transmit, 0=receive)

#define MANUAL_DURATION_H 0x01 // 300s = 0x012C
